...
void set_motors() {
  for (int i = 0; i < NUM_MOTORS; i++) {
    ...
    Serial.print("inside set_motors THRUST"); Serial.print(i); Serial.print(" = "); Serial.println(motor_power[i]);
    ...
    Serial.print("inside set_motors PWM"); Serial.print(i); Serial.print(" = "); Serial.println(T100LUT[lut_idx]);
...
void set_motors_raw(long *pwms) {
  ...
  for(int i = 0; i < NUM_MOTORS; i++) {
    Serial.print("inside set_motors_raw "); Serial.print(i); Serial.print(" = "); Serial.println(pwms[i]);
